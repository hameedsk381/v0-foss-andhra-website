      ...
      <div className="container max-w-4xl py-12 px-4 md:px-6">
        <motion.div initial="hidden" animate="visible" variants={fadeIn} className="space-y-8">
          <div className="space-y-2 text-center">
            <h1 className="font-display text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-foreground">Terms of Service</h1>
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Definitions</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Account Registration</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">User Conduct</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">You agree not to use our website and services to:</p>
            <ul className="list-disc list-inside text-muted-foreground md:text-lg/relaxed space-y-1 pl-4">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Third-Party Websites and Services</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Changes to These Terms</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
