      ...
      <div className="container max-w-4xl py-12 px-4 md:px-6">
        <motion.div initial="hidden" animate="visible" variants={fadeIn} className="space-y-8">
          <div className="space-y-2 text-center">
            <h1 className="font-display text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-foreground">Refund Policy</h1>
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Membership Fees</h2>
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Event Registration Fees</h2>

            <div className="space-y-2">
              <h3 className="text-xl font-semibold">Cancellation by You</h3>
              <p className="text-muted-foreground md:text-lg/relaxed">If you cancel your registration for an event:</p>
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Program Fees</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Digital Products</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Exceptions</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
