...
export default function FOSStarPage() {
  const [programData, setProgramData] = useState<Program>({
    id: PROGRAMS_BY_ID.fosstar.id,
    name: PROGRAMS_BY_ID.fosstar.slug,
    title: PROGRAMS_BY_ID.fosstar.displayName,
    description: PROGRAMS_BY_ID.fosstar.description,
    color: PROGRAMS_BY_ID.fosstar.themeClass,
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <ProgramContactSection
        description="Have questions about our membership program or interested in joining? Contact the FOSStar team."
        iconBgClass="bg-fosstar/10"
        iconClass="text-fosstar"
        submitButtonClass="bg-fosstar text-white hover:bg-fosstar/90"
      />
    </div>
  )
}
