      ...
      <div className="container max-w-4xl py-12 px-4 md:px-6">
        <motion.div initial="hidden" animate="visible" variants={fadeIn} className="space-y-8">
          <div className="space-y-2 text-center">
            <h1 className="font-display text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-foreground">Privacy Policy</h1>
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Disclosure of Your Information</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
          ...
          <motion.section variants={fadeIn} className="space-y-4">
            <h2 className="font-display text-2xl font-bold text-foreground">Security of Your Information</h2>
            <p className="text-muted-foreground md:text-lg/relaxed">
